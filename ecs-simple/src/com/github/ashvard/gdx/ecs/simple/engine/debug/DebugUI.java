...
import com.github.ashvard.gdx.ecs.simple.engine.debug.drawobject.DebugDrawObject;
import com.github.ashvard.gdx.ecs.simple.utils.ViewHelper;
import com.github.ashvard.gdx.ecs.simple.utils.cache.PeriodCacheValueInt;
import com.github.ashvard.gdx.ecs.simple.utils.cache.PeriodCacheValueLong;
...
public class DebugUI extends ScreenAdapter {
    ...
    public DebugUI(DebugService debugService) {
        ...
        for (com.github.ashvard.gdx.ecs.simple.engine.DebugSystem debugSystem : debugService.getSystems()) {
    ...
    private void updateData(float delta) {
        Array<com.github.ashvard.gdx.ecs.simple.engine.DebugSystem> systems = debugService.getSystems();
    ...
    public static class SystemUiData {
        ...
        public SystemUiData(com.github.ashvard.gdx.ecs.simple.engine.DebugSystem system) {
